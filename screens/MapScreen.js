...
import WaitingForTheDriver from '../components/WaitingForTheDriver';
    ...
    <View>
      ...
      <View style={tw`h-1/2`}>
        <Stack.Navigator>
            ...
            <Stack.Screen name='WaitingForTheDriver' component={WaitingForTheDriver} options={{headerShown: false,}}/>
        </Stack.Navigator>
      </View>
    </View>
  )
